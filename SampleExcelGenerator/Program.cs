...
class Program
{
    static void Main(string[] args)
    {
        ...
        string outputPath = args.Length > 0 ? args[0] : "SampleLoans.xlsx";
        CreateSampleExcel(outputPath);
        Console.WriteLine($"Sample Excel file created: {outputPath}");
    }

    static void CreateSampleExcel(string filePath)
    {
        ...
        var sampleData = new[]
        {
            new { Id = 1, Name = "Nguyễn Văn A", Principal = 100000000m, Rate = 12m, Date = new DateTime(2024, 1, 1), Term = 12, Type = "Simple", Status = "Active", Notes = "Vay mua nhà" },
            new { Id = 2, Name = "Trần Thị B", Principal = 50000000m, Rate = 10m, Date = new DateTime(2024, 1, 15), Term = 24, Type = "Compound", Status = "Active", Notes = "Vay kinh doanh" },
            new { Id = 3, Name = "Lê Văn C", Principal = 200000000m, Rate = 8.5m, Date = new DateTime(2024, 2, 1), Term = 36, Type = "Compound", Status = "Active", Notes = "Vay mua xe" },
            new { Id = 4, Name = "Phạm Thị D", Principal = 75000000m, Rate = 11m, Date = new DateTime(2024, 2, 10), Term = 18, Type = "Simple", Status = "Active", Notes = "Vay tiêu dùng" },
            new { Id = 5, Name = "Hoàng Văn E", Principal = 150000000m, Rate = 9m, Date = new DateTime(2024, 2, 20), Term = 24, Type = "Compound", Status = "Active", Notes = "Vay đầu tư" }
        };
